...
class PolylineLayerX extends StatelessWidget {
  /// List of polylines to draw.
  final List<PolylineX> polylines;

  final bool polylineCulling;

  const PolylineLayerX({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final List<PolylineX> lines = polylineCulling
        ? polylines.where((p) {
